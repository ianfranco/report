 ...
 * @author ianfr
 */
public class Febrero2017 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Febrero2017(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaFebrero.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaFebreroSM.jrxml");
            }
