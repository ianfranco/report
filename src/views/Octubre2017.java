 ...
 * @author ianfr
 */
public class Octubre2017 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Octubre2017(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoOctubre17.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoOctubre17SM.jrxml");
            }
