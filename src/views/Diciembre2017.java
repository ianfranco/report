 ...
 * @author ianfr
 */
public class Diciembre2017 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Diciembre2017(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoDiciembre17.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoDiciembre17_sm.jrxml");
            }
