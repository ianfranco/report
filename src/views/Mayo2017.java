 ...
 * @author ianfr
 */
public class Mayo2017 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Mayo2017(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaMayo_1.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaMayo_1SM.jrxml");
            }
