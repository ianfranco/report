 ...
 * @author ianfr
 */
public class Enero2017 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Enero2017(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaEnero_2.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaEnero_2SM.jrxml");
            }
