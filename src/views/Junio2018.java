...
public class Junio2018
{
  ...
  public Junio2018(ReporterVBView frame, MesSelectorlLiquidacionView view)
  {
    this.frame = frame;
    this.view = view;
  }
  ...
  public void loadLiquidacion(boolean flag, int operador) {
    ...
    try
    {
      ...
      switch (operador) {
      case 0: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoJunio18_CONDUCTOR.jrxml");
        break;
      case 1: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoJunio18_CONDUCTOR_solymar1.jrxml");
        break;
      case 2: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoJunio18_flota_gallardo_conductor.jrxml");
      }
