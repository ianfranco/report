...
public class Mayo2018
{
  private ReporterVBView frame;
  private MesSelectorlLiquidacionView view;
  
  public Mayo2018(ReporterVBView frame, MesSelectorlLiquidacionView view)
  {
    this.frame = frame;
    this.view = view;
  }
  ...
  public void loadLiquidacion(boolean flag, int operador) {
    ...
    try
    {
      ...
      switch (operador) {
      case 0: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoMayo18.jrxml");
        break;
      case 1: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoMayo18_sm.jrxml");
        break;
      case 2: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoMayo18_flota_gallardo.jrxml");
      }
