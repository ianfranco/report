 ...
 * @author ianfr
 */
public class Marzo2018 {
//test commit
    private 
            ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Marzo2018(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoMarzo18.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoMarzo18SM.jrxml");
            }
