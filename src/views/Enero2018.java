 ...
 * @author ianfr
 */
public class Enero2018 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Enero2018(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoEnero18.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoEnero18_sm.jrxml");
            }
