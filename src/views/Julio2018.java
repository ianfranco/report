...
public class Julio2018
{
  private ReporterVBView frame;
  private MesSelectorlLiquidacionView view;
  
  public Julio2018(ReporterVBView frame, MesSelectorlLiquidacionView view)
  {
    this.frame = frame;
    this.view = view;
  }
  ...
  public void loadLiquidacion(boolean flag, int operador) {
    ...
    try
    {
      ...
      switch (operador) {
      case 0: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoJulio18_conductor.jrxml");
        break;
      case 1: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoJulio18_conductor_sm.jrxml");
        break;
      case 2: 
        jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoJulio18_flota_gallardo_conductor_1.jrxml");
      }
