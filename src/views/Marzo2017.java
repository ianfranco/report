 ...
 * @author ianfr
 */
public class Marzo2017 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Marzo2017(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaMarzo.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaMarzoSM.jrxml");
            }
