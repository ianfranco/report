 ...
 * @author ianfr
 */
public class Abril2017 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Abril2017(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaAbril.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-LiquidacionSueldoDinamicaAbrilSM.jrxml");
            }
