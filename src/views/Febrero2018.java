 ...
 * @author ianfr
 */
public class Febrero2018 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Febrero2018(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoFebrero18.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoFebrero18_sm.jrxml");
            }
