 ...
 * @author ianfr
 */
public class Noviembre2016 {

    private ReporterVBView frame;
    private MesSelectorlLiquidacionView view;

    public Noviembre2016(ReporterVBView frame, MesSelectorlLiquidacionView view) {
        this.frame = frame;
        this.view = view;
    }
    ...
    public void loadLiquidacion(boolean flag, int operador) {
        ...
        try {
            ...
            if(operador == 0){
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoNoviembre16.jrxml");
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/junio17/INF-LiquidacionSueldoNoviembre16SM.jrxml");
            }
