 ...
 * @author ianfr
 */
public class RetencionJudicialController {
    ...
    public RetencionJudicialController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Retencion_judicial.jrxml");
            ...
            /*if(index ==0 ){
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-Retencion_judicial.jrxml");
                System.out.println(index);
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-Retencion_judicial_sm.jrxml");
                System.out.println(index);
            }*/            

            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Retención Judicial");
