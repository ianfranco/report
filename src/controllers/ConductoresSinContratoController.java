 ...
 * @author ianfr
 */
public class ConductoresSinContratoController {
    ...
    public ConductoresSinContratoController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            if(index ==0 ){
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-Conductores_sin_contrato.jrxml");
                System.out.println(index);
            }else{
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-Conductores_sin_contrato_sm.jrxml");
                System.out.println(index);
            }
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Conductores Sin Contratos");
