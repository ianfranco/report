 ...
 * @author ianfr
 */
public class DistribucionTerminalController {
    ...
    public DistribucionTerminalController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Distribucion_terminal.jrxml");
