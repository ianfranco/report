 ...
 * @author ianfr
 */
public class ImposicionesConductorController {
    ...
    public ImposicionesConductorController(ConductoresView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void view() {
        ...
        if (trabajador != null) {
            ...
            trabajador = (Trabajador) this.boxModel.getElementAt(index);
            System.err.println("CODIGO:"+this.trabajador.getIdTrabajador());
            jasper(true);
        }
    }
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            String nombre = this.trabajador.getApellidoPaternoTrabajador() + " " + this.trabajador.getApellidoMaternoTrabajador() + " " + trabajador.getNombreTrabajador();
            ...
            jasperReport = JasperCompileManager.compileReport("jrxml/INF-Conductor_imposiciones.jrxml");
            Conexion con = new Conexion();

            JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, params, con.getConnection());

            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Imposiciones:" + nombre);
