 ...
 * @author ianfr
 */
public class SeguroCesantiaTresController {
    ...
    public SeguroCesantiaTresController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Cesantia_30.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Seguro Cesanta 3.0%");
