...
public class SaldoAnteriorController {
    ...
    public SaldoAnteriorController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-SaldoAnterior.jrxml");
            ...
            if (index == 0) {
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-SaldoAnterior.jrxml");
                System.out.println(index);
            } else {
                jasperReport = JasperCompileManager.compileReport("jrxml/INF-SaldoAnterior_sm.jrxml");
                System.out.println(index);
            }*/
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Saldo Anterior");
