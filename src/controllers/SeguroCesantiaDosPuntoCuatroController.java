 ...
 * @author ianfr
 */
public class SeguroCesantiaDosPuntoCuatroController {
    ...
    public SeguroCesantiaDosPuntoCuatroController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Cesantia_24.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Seguro Cesanta 2.4%");
