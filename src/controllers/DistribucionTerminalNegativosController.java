 ...
 * @author ianfr
 */
public class DistribucionTerminalNegativosController {
    ...
    public DistribucionTerminalNegativosController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-DistribucionNegativos_terminal.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Distribución:Terminal +");
