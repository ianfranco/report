 ...
 * @author ianfr
 */
public class DistribucionCargasFamiliaresController {
    ...
    public DistribucionCargasFamiliaresController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            if (index == 0) {
                this.idOperador = 0;
                this.operador = "VIÑA BUS S.A.";
            } else {
                this.idOperador = 1;
                this.operador = "MILLENIUM";
            }
            
            params.put("idOperador", idOperador);
            params.put("operador", operador);
            
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Distribucion_cargasfamiliares.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Dist:Cargas Familiares");
