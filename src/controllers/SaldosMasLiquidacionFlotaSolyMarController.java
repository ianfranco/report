 ...
 * @author ianfr
 */
public class SaldosMasLiquidacionFlotaSolyMarController {
    ...
    public SaldosMasLiquidacionFlotaSolyMarController(FlotaView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasperIndividual(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/Liquidacion_por_flota_2.jrxml");
