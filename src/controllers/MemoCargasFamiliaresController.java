 ...
 * @author ianfr
 */
public class MemoCargasFamiliaresController {
    ...
    public MemoCargasFamiliaresController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Memo-CargasFamiliares.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Memo:Cargas Familiares");
