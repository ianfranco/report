 ...
 * @author ianfr
 */
public class SaldosProduccionFlotaController {
    ...
    public SaldosProduccionFlotaController(FlotaView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasperIndividual(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-LiquidacionSaldosxFlotaIndividual.jrxml");
