...
public class CajaCompensacionController {
    ...
    public CajaCompensacionController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            params.put("idOperador", this.idOperador);
            params.put("operador", this.operador);
            
            
            jasperReport = JasperCompileManager.compileReport("jrxml/INF-CajaCompensacion.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Caja Compensación");
