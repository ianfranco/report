 ...
 * @author ianfr
 */
public class ReconocimientoDeudasController {
    ...
    public ReconocimientoDeudasController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Distribucion_Reconocimiento_deudas.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Reconocimientos de Deudas");
