 ...
 * @author ianfr
 */
public class VoucherCargasFamiliaresController {
    ...
    public VoucherCargasFamiliaresController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            jasperReport = JasperCompileManager.compileReport("jrxml/Cargas_Familiares.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Voucher:Cargas Familiares");
