 ...
 * @author ianfr
 */
public class ProduccionConductorController {
    ...
    public ProduccionConductorController(ConductoresView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            jasperReport = JasperCompileManager.compileReport("jrxml/INF-Produccion_conductor.jrxml");
            Conexion con = new Conexion();

            JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, params, con.getConnection());

            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "INF-Producción Conductor:" + nombre);
