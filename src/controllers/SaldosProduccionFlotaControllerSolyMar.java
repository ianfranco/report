 ...
 * @author ianfr
 */
public class SaldosProduccionFlotaControllerSolyMar {
    ...
    public SaldosProduccionFlotaControllerSolyMar(FlotaView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-LiquidacionSaldosxFlotaIndividual_sm.jrxml");
