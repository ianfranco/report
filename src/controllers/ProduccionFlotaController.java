 ...
 * @author ianfr
 */
public class ProduccionFlotaController {
    ...
    public ProduccionFlotaController(FlotaView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            jasperReport = JasperCompileManager.compileReport("jrxml/INF-Produccion_flota.jrxml");
            Conexion con = new Conexion();

            JasperPrint jasperPrint = JasperFillManager.fillReport(jasperReport, params, con.getConnection());

            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Producción x Flota:" + flota.getNombreFlota());
