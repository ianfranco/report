 ...
 * @author ianfr
 */
public class DistribucionSindicatosController {
    ...
    public DistribucionSindicatosController(MesSelectorView view, ReporterVBView frame) {
        this.view = view;
        this.frame = frame;
    ...
    private void jasper(boolean flag) {
        ...
        try {
            ...
            InputStream in = getClass().getResourceAsStream("/jrxml/INF-Distribucion_sindicatos.jrxml");
            ...
            if (flag) {
                this.frame.setNewReport(new JRViewer(jasperPrint), "Distribución:Sindicatos");
